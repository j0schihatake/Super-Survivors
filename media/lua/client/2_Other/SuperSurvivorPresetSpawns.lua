...
PresetSpawns[#PresetSpawns+1] = {Suit = "Worker", Greeting = "Bill here is an Idiot",PerkName = "Blunt",PerkLevel = 3,isFemale=false,  Name = "Bob", X = 10077, Y = 9545, Z = 0 , Weapon = "Base.ClubHammer", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit = "Worker", Greeting = "Breaks over time to get back to work....haha JK",PerkName = "Blunt",PerkLevel = 3,isFemale=false,  Name = "Bill", X = 10075, Y = 9545, Z = 0 , Weapon = "Base.Shovel", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Formal", Greeting = "Pastor Bob was right, all us sinners are having to pay!", Name = "Giga Shop Owner", X = 12033, Y = 6849, Z = 1 , Weapon = "Base.Screwdriver", Orders = "Standing Ground", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Formal", Greeting = "Bonjour! Rooms are now free. Do you have somewhere better to stay?", Name = "Hotel Manager", X = 12009, Y = 6919, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = false}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster",  Name = "Thug", X = 12310, Y = 6729, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=0,PY=-5};
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster",  Name = "Thug", X = 12313, Y = 6729, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=0,PY=-5};
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster",  Name = "Thug", X = 12316, Y = 6729, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=0,PY=-5};

PresetSpawns[#PresetSpawns+1] = {Suit = "Formal", Name = "Principal", X = 11327, Y = 6765, Z = 1 , Weapon = "Base.Plank", Orders = "Patrol", isHostile = false, Patrolling=true, PX=2,PY=0};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Doctor", GroupID = HillTopGroupID, NoParty = true, Greeting = "If you need some medical treatment, stop by anytime.", Role="Doctor",Name = getText("ContextMenu_SD_DoctorPrefix_Before").."Hilltop"..getText("ContextMenu_SD_DoctorPrefix_After"), X = 11722, Y = 7942, Z = 0 , PerkName="Doctor",PerkLevel=3, Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false, AIMode = ""}
PresetSpawns[#PresetSpawns+1] = {Suit = "Farmer", GroupID = HillTopGroupID, NoParty = true, Role="Farmer",Name = "Hilltop Farmer", X = 11733, Y = 7936, Z = 0 , PerkName="Farming",PerkLevel=5, Weapon = getWeapon("Base.HuntingKnife"), Orders = "Farming", isHostile = false}
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", GroupID=Gang1GroupID, Name = "Gang Member1", X = 11373, Y = 7034, Z = 0 , Weapon = "Base.Pistol", Orders = "Guard", isHostile = true };  
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", GroupID=Gang1GroupID,  Name = "Gang Member2", X = 11370, Y = 7036, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true,Orders = "Patrol", Patrolling=true, PX= 10,PY=0};
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", GroupID=Gang1GroupID,  Name = "Gang Member3", X = 11374, Y = 7027, Z = 0 , Weapon = "Base.Shotgun", Orders = "Guard", isHostile = true,Orders = "Patrol", Patrolling=true, PX= 0,PY=2};
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", GroupID=Gang1GroupID,  Name = "Gang Member4", X = 11364, Y = 7024, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true,Orders = "Patrol", Patrolling=true, PX= -1,PY=0};
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", GroupID=Gang1GroupID,  Name = "Gang Member5", X = 11365, Y = 7032, Z = 0 , Weapon = "Base.Pistol", Orders = "Guard", isHostile = true,Orders = "Patrol", Patrolling=true, PX= -13,PY=0};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", RouteID="TrainTracksToValleyStation",GroupID=Gang2GroupID,  Name = "Bandit", X = BaseX, Y = BaseY+1, Z = 0 , Weapon = "Base.Shotgun", Orders = "FollowRoute", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", RouteID="TrainTracksToValleyStation",GroupID=Gang2GroupID,  Name = "Bandit", X = BaseX+1, Y = BaseY+1, Z = 0 , Weapon = "Base.Shotgun", Orders = "FollowRoute", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", GroupID=LoslokosGroupID, Name = "Loslokos Gang Member", X = 11660, Y = 7039, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", GroupID=LoslokosGroupID,  Name = "Loslokos Gang Member", X = 11660, Y = 7041, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", GroupID=LoslokosGroupID,  Name = "Loslokos Gang Member", X = 11660, Y = 7040, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", GroupID=LoslokosGroupID,  Name = "Loslokos Gang Member", X = 11659, Y = 7039, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit = "Gangster", GroupID=LoslokosGroupID,  Name = "Loslokos Gang Member", X = 11659, Y = 7041, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Formal", Greeting = "Praise God! Hallelujah!",isFemale = false,  Name = "Pastor Bob", X = 11973, Y = 6990, Z = 0 , Weapon = "Base.Plank", Orders = "Standing Ground", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Formal", Greeting = "He has sent me a miracle. Amen!",isFemale = false,  Name = "Pastor Aaron", X = 11096, Y = 6710, Z = 0 , Weapon = "Base.Plank", Orders = "Standing Ground", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Fireman", Greeting = "As you can tell, I\'m an axe man",PerkName = "Axe",PerkLevel = 5,  Name = "Lumberjack", X = 12064, Y = 7213, Z = 0 , Weapon = "Base.Axe", Orders = "Chop Wood", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Doctor", Greeting = "Doctor Kildare? Oh.. how did you get up here? The doors should have been locked. Are you bitten?",PerkName = "Doctor",PerkLevel = 3,isFemale=true,  Name = "Nurse", X = 10880, Y = 10029, Z = 1 , Weapon = "Base.KitchenKnife", Orders = "Doctor", isHostile = false}; 
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Formal", Greeting = "ARRRRGGH!!!! Got you! Don\'t even think about escaping!",  Name = "Attorney", X = 7991, Y = 11449, Z = 0 , Weapon = "Base.Golfclub", Orders = "Standing Ground", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Hunter", Greeting = "I\'ve have been watching you, but you seem friendly. How did you make it out alive?",PerkName = "Aiming",PerkLevel = 7,isFemale=false,  Name = "Hunter", X = 12475, Y = 8969, Z = 0 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Patrol", isHostile = false,Patrolling=true, PX=10,PY=0};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Worker", Greeting = "Ya better be real cool buddy, or I\'ll shovel your sorry ass outta here.",PerkName = "Blunt",PerkLevel = 3,isFemale=false,  Name = "Construction Worker", X = 14087, Y = 5453, Z = 0 , Weapon = "Base.Shovel", Orders = "Standing Ground", isHostile = false};
...
-- NORTH EAST BLOCKADE
PresetSpawns[#PresetSpawns+1] = {Suit = "Farmer", GroupID = BlockadeGroupID, NoParty = true, Role="Farmer",Name = "Freelance Farmer", X = 12483, Y = 4442, Z = 0 , PerkName="Farming",PerkLevel=5, Weapon = getWeapon("Base.HuntingKnife"), Orders = "Farming", isHostile = false}
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, InitGreeting = getText("ContextMenu_speech_BlockadeIntro"), PerkName = "Aiming",PerkLevel = 10, NoParty = true, isFemale=false,   Name = "General Carter", X = 12508, Y = 4487, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "Move along now", PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12512, Y = 4487, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12517, Y = 4487, Z = 0 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "You\'re not supposed to be up here, Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12499, Y = 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "What are you doing up here? Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12527, Y = 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "I\'m busy", PerkName = "Aiming", PerkLevel = 2, NoParty = true, isFemale=false,   Name = "Soldier", X = 12527, Y = 4485, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=-35,PY=-13}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Cook", GroupID = BlockadeGroupID, Greeting = "I\'m busy", NoParty = true, isFemale=false,   Name = "Cook", X = 12481, Y = 4446, Z = 0 , Weapon = "Base.KitchenKnife", Orders = "Patrol", isHostile = false, Patrolling=true, PX=-4,PY=-8}; 
...
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "I\'m busy", PerkName = "Aiming", PerkLevel = 2, NoParty = true,   Name = "Soldier", X = 12541, Y = 4456, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=0,PY=0,PZ=1}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "We cannot wait any longer! We must proceed with operation Bluejay NOW!", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Captian", X = 12540, Y = 4402, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "Communication has been down for far too long. We must assume the worst.", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Major Mike", X = 12533, Y = 4405, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "We can\'t hold off here without backup for much longer. We need to do something!", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Lt. Dan", X = 12533, Y = 4407, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12512, Y = 4400, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12515, Y = 4400, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Go No Futher!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12519, Y = 4397, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12508, Y = 4397, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting = "No one may pass the Blockade. NO exceptions!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12505, Y = 4417, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=15,PY=0}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting = "No one may pass the Blockade. NO exceptions!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12470, Y = 4425, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=15,PY=17}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12552, Y = 4397, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Go No Further!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12556, Y = 4458, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting = "Talk to the General up by the North West Entrance", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Srgt. Sam", X = 12552, Y = 4498, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Doctor", GroupID = BlockadeGroupID, Greeting = "Need some treatment?", PerkName = "Doctor", isFemale=false, PerkLevel = 3, NoParty = true,   Name = getText("ContextMenu_SD_DoctorPrefix_Before").."Dan"..getText("ContextMenu_SD_DoctorPrefix_After"), X = 12483, Y = 4457, Z = 0 , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting = "Move along now", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Soldier", X = 12555, Y = 4498, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Worker", GroupID = BlockadeGroupID, NoParty=true,Greeting = "I\'m supposed to take down all these trees.",PerkName = "Axe",PerkLevel = 5,  Name = "Worker", X = 12555, Y = 4478, Z = 0 , Weapon = "Base.Axe", Orders = "Explore", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting = "I tried to warn everyone, no one would listen.",PerkName = "Aiming",PerkLevel = 6,  Name = "Private Manning", X = 12467, Y = 4409, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol",  Patrolling=true, PX=0,PY=9, isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", roupID = BlockadeGroupID, Greeting="Hey! Your not aloud in here!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12497, Y = 4366, Z = 3 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=-4,PY=-7}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Hey! Your not aloud in here!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12537, Y = 4368, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=-25,PY=1}; 
...
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "This is the North East Blockade. No one is aloud past the rear Blockade. Lethal force will be used if necessary", PerkName = "Aiming",PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Captain B.J. Blazkowicz", X = 12508, Y = (-2*300) + 4487, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "Move along now", PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12512, Y = (-2*300) + 4487, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12517, Y = (-2*300) +4487, Z = 0 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "You\'re not supposed to be up here, Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12499, Y = (-2*300) + 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "What are you doing up here? Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12527, Y = (-2*300) + 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "I\'m busy", PerkName = "Aiming", PerkLevel = 2, NoParty = true, isFemale=false,   Name = "Soldier", X = 12527, Y = (-2*300) + 4485, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=-35,PY=-13}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Cook", GroupID = BlockadeGroupID, Greeting = "I\'m busy", NoParty = true, isFemale=false,   Name = "Cook", X = 12481, Y = (-2*300) + 4446, Z = 0 , Weapon = "Base.KitchenKnife", Orders = "Patrol", isHostile = false, Patrolling=true, PX=-4,PY=-8}; 
...
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "I\'m busy", PerkName = "Aiming", PerkLevel = 2, NoParty = true,   Name = "Soldier", X = 12541, Y = (-2*300) + 4456, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=0,PY=0,PZ=1}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "We cannot wait any longer! We must proceed with operation Bluejay NOW!", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Captian", X = 12540, Y = (-2*300) + 4402, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "Communication has been down for far too long. We must assume the worst.", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Major Mike", X = 12533, Y = (-2*300) + 4405, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "ArmyCamo", GroupID = BlockadeGroupID, Greeting = "We can\'t hold off here without backup for much longer. We need to do something!", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Lt. Dan", X = 12533, Y = (-2*300) + 4407, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12512, Y = (-2*300) + 4400, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12515, Y = (-2*300) + 4400, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Go No Futher!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12519, Y = (-2*300) + 4397, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12508, Y = (-2*300) + 4397, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting = "No one may pass the Blockade. NO exceptions!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12505, Y = (-2*300) + 4417, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=15,PY=0}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting = "No one may pass the Blockade. NO exceptions!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12470, Y = (-2*300) + 4425, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=15,PY=17}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12552, Y = (-2*300) + 4397, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Go No Further!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12556, Y = (-2*300) + 4397, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting = "Talk to the Captain up by the North West Entrance", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Srgt. Sam", X = 12552, Y = (-2*300) + 4498, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting = "Move along now", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Soldier", X = 12555, Y = (-2*300) + 4498, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Worker", GroupID = BlockadeGroupID, NoParty=true,Greeting = "I\'m supposed to take down all these trees.",PerkName = "Axe",PerkLevel = 5,  Name = "Worker", X = 12555, Y = (-2*300) + 4478, Z = 0 , Weapon = "Base.Axe", Orders = "Explore", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting = "I tried to warn everyone, no one would listen.",PerkName = "Aiming",PerkLevel = 6,  Name = "Private Manning", X = 12467, Y = (-2*300) + 4409, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol",  Patrolling=true, PX=0,PY=9, isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Hey! Your not allowed in here!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12497, Y = (-2*300) + 4366, Z = 3 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=-4,PY=-7}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Hey! Your not allowed in here!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12537, Y = (-2*300) + 4368, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=-25,PY=1}; 
	if isModEnabled("SurvivorQuests") then
			PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Hey! You're not allowed up here!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12505, Y = 3742, Z = 0 , Weapon = "Base.AssaultRifle", Orders = "Patrol", isHostile = true, Patrolling=true, PX=0,PY=-7}; 
			PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Hey! You're not allowed over here!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12506, Y =3752, Z = 0 , Weapon = "Base.Pistol", Orders = "Guard", isHostile = true}; 
			PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Hey! You're not allowed in here!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12499, Y = 3764, Z = 0 , Weapon = "Base.AssaultRifle", Orders = "Guard", isHostile = true}; 
			PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Hey! You're not allowed over here!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12459, Y = 3759, Z = 0 , Weapon = "Base.Pistol", Orders = "Guard", isHostile = true}; 
			PresetSpawns[#PresetSpawns+1] = {Suit = "Army", GroupID = BlockadeGroupID, Greeting="Hey! You're not alloweed over here!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12459, Y = 3778, Z = 0 , Weapon = "Base.AssaultRifle", Orders = "Guard", isHostile = true}; 
...
-- prison
PresetSpawns[#PresetSpawns+1] = {Suit = "Guard", Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7753, Y = 11884, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Guard", Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7753, Y = 11889, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Guard", Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7743, Y = 11905, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Guard", Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7709, Y = 11878, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = true}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Guard", Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7680, Y = 11878, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Explore", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Guard", Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7680, Y = 11878, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Explore", isHostile = true}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Guard", Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7651, Y = 11855, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Explore", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Guard", Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7651, Y = 11855, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Explore", isHostile = true}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Guard", Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7729, Y = 11913, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Explore", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Guard", Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7729, Y = 11913, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Explore", isHostile = true}; 

--recruitable farmers
PresetSpawns[#PresetSpawns+1] = {Suit = "Farmer", Greeting = "You\'re the one stealing my crops? I\'m sure it was no damn zombie. These city folk don\'t know how to fend for themselves. We can work together here",isFemale = false, PerkName="Farming",PerkLevel=5,  Name = "Farmer John", X = 11137, Y = 6855, Z = 1 , Weapon = "Base.Hammer",  Orders = "Patrol", isHostile = false, Patrolling=true, PX=0,PY=-4};
...
--recuritable doctors
PresetSpawns[#PresetSpawns+1] = {Suit = "Doctor", X = 10877, Y = 10029, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor", PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Doctor", X = 8093, Y = 11521, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor",  PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Doctor", X = 11882, Y = 6883, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor", PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Doctor", X = 11937, Y = 6797, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor", PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Doctor", X = 10143, Y = 12750, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor", PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Doctor", X = 6477, Y = 5259, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor", PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
